...
public class PostController {
	...
	public Object modifyPost(HttpServletResponse response, @RequestBody Post postParam) {
	    ...
	    Post post = new Post(postParam.getId(), postParam.getTitle(), postParam.getContent(), null);
	    ...
	    if (isSuccess) {
	        ...
	        // Jika gagal, atur status respons ke INTERNAL_SERVER_ERROR dan kembalikan respons kegagalan
	        response.setStatus(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
	        return new Result(500, "Fail");
	    }
	}
